...
public class SouthPointerSave extends View {
    ...
    public SouthPointerSave(Context context) {
        this(context, null);
    }

    public SouthPointerSave(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void obtainStyledAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            mHourPointWidth = array.getDimension(R.styleable.SouthPointer_sp_hour_pointer_width, DptoPx(5));
            mMinutePointWidth = array.getDimension(R.styleable.SouthPointer_sp_minute_pointer_width, DptoPx(3));
            mSecondPointWidth = array.getDimension(R.styleable.SouthPointer_sp_second_pointer_width, DptoPx(2));
            ...
            mHourPointColor = array.getColor(R.styleable.SouthPointer_sp_hour_pointer_color, Color.BLACK);
            mMinutePointColor = array.getColor(R.styleable.SouthPointer_sp_minute_pointer_color, Color.BLACK);
            mSecondPointColor = array.getColor(R.styleable.SouthPointer_sp_second_pointer_color, Color.RED);
        } catch (Exception e) {
            //一旦出现错误全部使用默认值
            mPadding = DptoPx(5);
            mTextSize = SptoPx(2);
    ...
    private void paintPointer(Canvas canvas) {
        ...
        RectF rectFHour = new RectF(-mHourPointWidth / 2, -mInnerRadius * 3 / 5, mHourPointWidth / 2, mPointEndLength);
        ...
        RectF rectFMinute = new RectF(-mMinutePointWidth / 2, -mInnerRadius * 3.5f / 5, mMinutePointWidth / 2, mPointEndLength);
        ...
        RectF rectFSecond = new RectF(-mSecondPointWidth / 2, -mInnerRadius + 15, mSecondPointWidth / 2, mPointEndLength);
